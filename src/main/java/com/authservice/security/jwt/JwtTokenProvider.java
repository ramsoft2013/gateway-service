...
import com.authservice.constants.ErrorMessage.TokenInvalid;
import com.authservice.exceptionHandler.UnauthorisedException;
...
import static com.authservice.constants.SecurityConstants.*;
...
public class JwtTokenProvider {
	...
	public Authentication getAuthentication(String token) {
        ...
        System.out.println("user details autherired ::"+userDetails.getAuthorities());
